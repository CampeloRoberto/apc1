...
falta so mexer na logica do ranking pra de fato ter um ranque de melhor jogador/pior jogador
...
char opcao  = 0; // por isso que o enter vai;
  ...
  struct rankings ranking[3]; // aqui a gente determina o tamanho do ranking talvez mudar para 3 vai rodar;
...
////////////////////////////////////////JOGO DA VELHA/////////////////////////////////////////////////////////////////
    ...
    do{
        ...
        }// como inicializar estrutura de dados
...
///////////////////////////                /JOGO DA COBRA///////////////////////////////////////////////////////////////////////////////////
            ...
            printf("\n");
            printf("\n");
            printf(" Digite o nome do jogador com  caracteres!!:  ");
            int k;
            int joaninha = scanf("%10s",ranking[k].nome);
            do{
                   printf("Digite a quantidade de vezes q vc jogou o programa (1 a 3): ");
            int golfinho = scanf("%d",&k);
...
// definindo a área do jogo, se não a cobra some
  ...
  printf("\e[?25l");// ---------------------------------------------tirando o cursor de novo pq reapareceu sozinho
    ...
    printf("\n");
      ...
      printf(" \n                                         SCORE = %i         ",score);
 do{
          //deu_certo = system("clear");  fica meio grosso! geralmente a gente perde apertando botao.
  printf(" \n                 Para voltar ao menu principal aperte '0'                             ");
  int ch = getchar();
 if ( ch == '0' ) {
  printf("\e[?25h");
    quit = 1;
 ...
 //sera que ainda preciso disso???     -          -           -            -                 -           -        -        -
  ...
  // Reaparecer com o cursor  e deixar o console normal,
  printf("\e[?25h");
 tcsetattr(STDIN_FILENO, TCSANOW, &oldt);
          ...
          for (int k = 0; k < 3; k++){
              printf(" O jogador %-10s fez %-2i pontos!\n",ranking[k].nome,ranking[k+1].score2);
          }


          // fazer a logica de ranking; talvez mudar pra 3
